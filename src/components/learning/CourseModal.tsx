            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <button 
                  ...
                  className="w-full btn-fill py-3 rounded-lg transition-colors duration-200"
                >
        ...
        {!isEnrolled ? (
          <div className="p-6 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <button 
                onClick={handleEnroll}
                className="btn-fill px-8 py-3 rounded-lg transition-colors duration-200 text-lg font-semibold"
              >
              ...
              <div className="lg:col-span-2">
                <div className="bg-gray-900 rounded-lg p-8 text-center text-primary-foreground mb-6">
                  ...
                  <button 
                    ...
                    className="btn-fill px-6 py-2 rounded-lg transition-colors duration-200"
                  >
