...
const MetricsDashboard: React.FC<MetricsDashboardProps> = ({ isOpen, onClose }) => {
  ...
  const categories = [
    { id: 'all', name: 'All Metrics', color: 'bg-muted' },
    { id: 'Growth', name: 'Growth', color: 'bg-success/15' },
    { id: 'Acquisition', name: 'Acquisition', color: 'bg-primary/10' },
    { id: 'Engagement', name: 'Engagement', color: 'bg-purple-100' },
    { id: 'Performance', name: 'Performance', color: 'bg-primary/10' },
    { id: 'Financial', name: 'Financial', color: 'bg-warning/15' },
  ...
  const getTrendIcon = (trend: string) => {
    switch (trend) {
      ...
      case 'down': return <TrendingUp className="h-4 w-4 text-destructive transform rotate-180" />;
      ...
      <div className="bg-card rounded-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center">
            ...
            <h2 className="text-xl font-bold text-foreground">PM Metrics Dashboard</h2>
          </div>
        ...
        <div className="p-6">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 ${
                  selectedCategory === category.id
                    ...
                    : `${category.color} text-foreground hover:bg-purple-100`
                }`}
              >
                {category.name}
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-gradient-to-r from-green-500 to-green-600 p-4 rounded-lg text-primary-foreground">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-4 rounded-lg text-primary-foreground">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-lg text-primary-foreground">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="bg-gradient-to-r from-primary to-primary p-4 rounded-lg text-primary-foreground">
              <div className="flex items-center justify-between">
                <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            {filteredMetrics.map(metric => {
              ...
              return (
                <div key={metric.id} className="bg-card border border-border rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="w-full bg-muted rounded-full h-2">
                      <div 
                        className={`h-2 rounded-full transition-all duration-300 ${
                          isOnTarget ? 'bg-success/100' : 'bg-primary'
                        }`}
                    ...
                    <div className="flex justify-between text-xs text-muted-foreground mt-1">
                      ...
                      <span className={isOnTarget ? 'text-success' : 'text-primary'}>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="bg-purple-600 text-primary-foreground px-6 py-3 rounded-lg hover:bg-purple-700 transition-colors duration-200 flex items-center space-x-2"
            >
