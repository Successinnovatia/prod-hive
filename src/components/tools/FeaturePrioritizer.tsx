...
Generated by PM Africa Tools
  ...
  const getPriorityLevel = (score: number) => {
    if (score >= 3) return { label: 'High', color: 'bg-success/15 text-success' };
    if (score >= 1) return { label: 'Medium', color: 'bg-warning/15 text-warning' };
      ...
      <div className="bg-card rounded-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center">
            ...
            <h2 className="text-xl font-bold text-foreground">Feature Prioritization Matrix</h2>
          </div>
        ...
        <div className="p-6">
          ...
          <div className="bg-muted p-4 rounded-lg mb-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Add New Feature</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="lg:col-span-3">
                <input
                  ...
                  className="w-full px-3 py-2 border border-input rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                />
              </div>
            ...
            <button
              onClick={addFeature}
              className="mt-4 bg-green-600 text-primary-foreground px-4 py-2 rounded-lg hover:bg-green-700 transition-colors duration-200 flex items-center space-x-2"
            >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-foreground">Prioritized Features</h3>
              <button
                ...
                <div key={feature.id} className="bg-card border border-border rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      <span className="bg-muted text-foreground px-2 py-1 rounded text-sm font-medium">
                        #{index + 1}
                      </span>
                      <input
                        type="text"
                        ...
                        className="text-lg font-semibold text-foreground bg-transparent border-none focus:outline-none focus:ring-2 focus:ring-green-500 rounded px-2"
                      />
                    </div>
                    <div className="flex items-center space-x-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    {[
                      { key: 'impact', label: 'Impact', color: 'bg-primary/10' },
                      { key: 'effort', label: 'Effort', color: 'bg-destructive/10' },
                      ...
                      { key: 'culturalAdaptation', label: 'Cultural', color: 'bg-success/10' }
                    ].map(({ key, label, color }) => (
