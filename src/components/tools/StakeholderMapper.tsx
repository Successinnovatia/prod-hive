...
const StakeholderMapper: React.FC<StakeholderMapperProps> = ({ isOpen, onClose }) => {
  ...
  const getQuadrant = (influence: number, interest: number) => {
    ...
    if (influence < 7 && interest >= 7) return { name: 'Keep Informed', color: 'bg-primary/10 border-primary/30' };
        ...
        <div className="p-6">
          ...
          <div className="bg-muted p-4 rounded-lg mb-6">
            ...
            <button
              ...
              className="mt-4 btn-fill px-4 py-2 rounded-lg transition-colors duration-200 flex items-center space-x-2"
            >
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="btn-fill px-4 py-2 rounded-lg transition-colors duration-200 flex items-center space-x-2"
              >
