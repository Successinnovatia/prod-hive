  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        ...
        alert('Sign in successful! Welcome back to ProdHive.');
      }, 1500);
    }
  };
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600">
              Sign in to your ProdHive account
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-orange-600 text-white py-4 rounded-lg hover:bg-orange-700 transition-all duration-200 font-semibold flex items-center justify-center space-x-2 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {isLoading ? (
                  <>
