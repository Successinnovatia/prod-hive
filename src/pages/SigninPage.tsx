...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Target, AlertCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        ...
        alert('Sign in successful! Welcome back to TechPod.');
      }, 1500);
    }
  };
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground">
              Sign in to your TechPod account
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-input rounded-lg shadow-sm bg-card text-sm font-medium text-muted-foreground hover:bg-muted transition-colors duration-200">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              Need help?{' '}
              <Link to="/support" className="text-primary hover:text-primary">
                Contact Support
              </Link>
            </p>
          </div>
